const CACHE_NAME='mzansi-learning-hub-v0.1b-01';
const APP_SHELL=['./','./index.html','./styles.css','./app.js','./hub-storage.js','./umla-import.js','./programmes.json','./fixtures/boilermaker-km04-l03-umla.json','./manifest.webmanifest'];
